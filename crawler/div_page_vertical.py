...
tf.app.flags.DEFINE_string('file_path', '/data/yangqianwen/istock/tmp4', 'Input image directory')
...
tf.app.flags.DEFINE_string('lower_limit', 800, 'Lowermost line for images')
...
tf.app.flags.DEFINE_string('save_dir', '/data/yangqianwen/istock/crop4', 'Output file path, where to store cropped images')
...
def divide_and_save_images(image_data, height, width, gap, label):
    """
        ...
        if extremes[0][0]==extremes[0][1] and extremes[1][0]==extremes[1][1] and extremes[2][0]==extremes[2][1] and i > y_last+100:
            ...
            while j < width:
               ...
               if extremes[0][0]==extremes[0][1] and extremes[1][0]==extremes[1][1] and extremes[2][0]==extremes[2][1] and j > x_last + 100:
                   ...
                   save_name = "%s/cropped_%d_%d_%d_%d_%d.jpg"%(FLAGS.save_dir,label+1, x_last,y_last, j, i) #, random.randrange(1000) )
...
def main():
    ...
    for i in xrange(len(filenames)):
        ...
        divide_and_save_images(image_data, height, width, FLAGS.gap_size, i)
        
if __name__=='__main__':
#    print FLAGS.file_path
#    print FLAGS.upper_limit
#    print FLAGS.lower_limit
#    print FLAGS.left_limit
#    print FLAGS.right_limit
#    print FLAGS.save_dir
#    print FLAGS.gap_size
    main()
